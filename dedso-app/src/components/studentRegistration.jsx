...
function StudentRegistration() {
  ...
  const handleSubmit = (e) => {
    ...
    <form className="studentInfo" onSubmit={handleSubmit} method="post">
        ...
        <input className="textbox-2" name="yearofStudy" type="text" placeholder="info" onChange={handleChange}/>
        <label htmlFor="">College Email</label>
        <input className="textbox-2" name="collegeEmail" type="email" placeholder="College Email"  onChange={handleChange}/>
